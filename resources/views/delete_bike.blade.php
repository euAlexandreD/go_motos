    ...
    <div class="row justify-content-center">
        <div class="col">
            ...
            <div class="col card p-5 text-center">
                ...
                <h4 class="text-info mb-3">{{ $bike->Model }}</h4>
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ route('deleteConfirm', ['id' => Crypt::encrypt($bike->id)]) }}" class="btn btn-danger px-5 m-2"><i class="fa-solid fa-trash me-2"></i>Yes</a>
                </div>
            </div>
        </div>
    </div>
